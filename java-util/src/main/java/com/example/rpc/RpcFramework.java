...
public class RpcFramework {
	...
	public static void main(String[] args) {
		Class<?> clazz = DemoIntf.class;
		Object bean = Proxy.newProxyInstance(clazz.getClassLoader(),
		...
		if (bean instanceof DemoIntf) {
			System.out.println(bean);
			System.out.println(((DemoIntf) bean).say());;
		}

	}

	static interface DemoIntf {
		String say();
	}
}